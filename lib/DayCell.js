...
var DayCell = (function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function getClassNames(classes) {
      ...
      var isOutsideMinMax = _props2.isOutsideMinMax;
      ...
      var isCurrentMonthDay = _props2.isCurrentMonthDay;

      return (0, _classnames3['default'])((_classnames = {}, _defineProperty(_classnames, classes.day, true), _defineProperty(_classnames, classes.dayActive, isSelected), _defineProperty(_classnames, classes.dayPassive, isPassive), _defineProperty(_classnames, classes.dayInRange, isInRange), _defineProperty(_classnames, classes.dayStartEdge, isStartEdge), _defineProperty(_classnames, classes.dayEndEdge, isEndEdge), _defineProperty(_classnames, classes.dayToday, isToday), _defineProperty(_classnames, classes.daySunday, isSunday), _defineProperty(_classnames, classes.daySpecialDay, isSpecialDay), _defineProperty(_classnames, classes.isCurrentMonthDay, isCurrentMonthDay), _defineProperty(_classnames, classes.isOutsideMinMax, isOutsideMinMax), _classnames));
    }
  }, {
    key: 'render',
...
DayCell.propTypes = {
  ...
  isCurrentMonthDay: _propTypes2['default'].bool,
  isInRange: _propTypes2['default'].bool,
  isOutsideMinMax: _propTypes2['default'].bool,
